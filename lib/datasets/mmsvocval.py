...
class mmsvocval(imdb):
    def __init__(self, image_set, devkit_path=None):
        imdb.__init__(self, 'mmsvocval_' + image_set)
        self._image_set = image_set
        self._devkit_path = self._get_default_path() if devkit_path is None \
                            else devkit_path
        self._data_path = self._devkit_path
        self._classes = ('__background__', # always index 0
                         'textfield', 'button', 'checkbox', 'dropdown','interesting')
    ...
    def _get_default_path(self):
        ...
        """
        #return os.path.join(cfg.DATA_DIR, 'testTFFRCNNVOC')
        return os.path.join("/media/axhe/volume/tf-faster-rcnn/data", 'MMSVOC3_val')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'MMS', 'Main')
    ...
    def _do_python_eval(self, output_dir = 'output'):
        ...
        for i, cls in enumerate(self._classes):
            ...
            print('rex for {} = {:.4f}'.format(cls, rec))
